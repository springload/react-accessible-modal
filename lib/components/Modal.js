...
export default React.createClass({
    ...
    afterOpen(e) {
        ...
        this.setState({ afterOpen: true }, () => {
            ...
            if (this.closeButton) this.closeButton.addEventListener('keydown', this.handleEnterKeyDown);
    ...
    setFocusTrap() {
        ...
        focusTrap.activate(modal, {
            initialFocus: ReactDOM.findDOMNode(content),
    ...
    render() {
        ...
        return this.shouldBeClosed()
            ? null
            : <div className={classList.join(' ')} ref="modal">
                <div className="modal__table">
                    <div className="modal__center">
                        <div ref="content" className="modal__content" onClick={stopPropagation} aria-label={label} aria-hidden="true" role="dialog">
                            {children}
