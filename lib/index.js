...
class Modal extends React.Component {
    ...
    open() {
        ...
        this.modalRef.addEventListener('animationend', this.afterOpen);
    }
    ...
    afterOpen(e) {
        ...
        this.modalRef.removeEventListener('animationend', this.afterOpen);
    ...
    handleClose() {
        ...
        this.modalRef.addEventListener('animationend', this.close);
        this.modalRef.classList.remove('modal--active');
        this.modalRef.classList.add('modal--exit');
        this.setState({
            beforeClose: true,
        });
    }
    ...
    close(e) {
        ...
        this.modalRef.removeEventListener('animationend', this.close);
        ...
        if (controls) {
            ...
            controlsMarkup = (
                <div className={`modal__control${insideControls ? ' modal__control--inside' : ''}`}>
                    <div
                        className="modal__control-item modal__close"
                        role="button"
                        tabIndex="0"
